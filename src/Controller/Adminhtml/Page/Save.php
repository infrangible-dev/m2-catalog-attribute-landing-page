    ...
    extends \Infrangible\BackendWidget\Controller\Backend\Object\Save
{
    ...
    {
        return __('The page has been created.')->render();
    }

    protected function getObjectUpdatedMessage(): string
    {
        return __('The page has been saved.')->render();
    }
     ...
     * @throws Exception
     */
    protected function checkUrlKey(string $urlKey, int $storeId, ?int $catalogAttributeLandingPageId = null)
    {
        ...
        if ($catalogAttributeLandingPage && $catalogAttributeLandingPage->getId() &&
            $catalogAttributeLandingPage->getId() != $catalogAttributeLandingPageId) {
            throw new Exception(__('The url key is use by another catalog attribute landing page!'));
        }
        ...
        if ($catalogAttributeLandingGroup && $catalogAttributeLandingGroup->getId()) {
            throw new Exception(__('The url key is use by a catalog attribute landing group!'));
        }
